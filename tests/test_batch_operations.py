...
class TestParseErrorMessage:
    ...
    def test_parse_json_error_message(self):
        ...
        result = parse_api_error_message(response)
...
class TestTimeoutConstants:
    ...
    def test_timeout_constants_exist(self):
        ...
        assert QUICK_TIMEOUT_SECONDS == 15